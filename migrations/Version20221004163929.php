 ...
 */
final class Version20221004163929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE alergenos (id INT AUTO_INCREMENT NOT NULL, alergeno VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE direccion ADD cliente_id INT NOT NULL, ADD provincia_id INT NOT NULL, ADD municipio_id INT NOT NULL, CHANGE puerta_piso_escalera puerta_piso_escalera VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE horario ADD restaurante_id INT NOT NULL, CHANGE dia dia INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE restaurante CHANGE imagen_url imagen_url VARCHAR(255) DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE alergeno (id INT AUTO_INCREMENT NOT NULL, alergeno VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE direccion DROP cliente_id, DROP provincia_id, DROP municipio_id, CHANGE puerta_piso_escalera puerta_piso_escalera VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE horario DROP restaurante_id, CHANGE dia dia DOUBLE PRECISION NOT NULL');
        ...
        $this->addSql('ALTER TABLE restaurante CHANGE imagen_url imagen_url VARCHAR(255) NOT NULL');
    }
}
